...
#realmente se ejecuta a las 08:45
scheduler.add_job(prediccionesAEMET, 'cron', day_of_week='mon-sun', hour=8, minute=6)
...
scheduler.add_job(noticias_del_dia, 'cron', day_of_week='mon-sun', hour=8, minute=5)
