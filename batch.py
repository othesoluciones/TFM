...
#realmente se ejecuta a las 08:45
scheduler.add_job(prediccionesAEMET, 'cron', day_of_week='mon-sun', hour=08, minute=5)
...
scheduler.add_job(noticias_del_dia, 'cron', day_of_week='mon-sun', hour=08, minute=4)
